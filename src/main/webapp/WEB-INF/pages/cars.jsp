...
<t:pageTemplate pageTitle="Cars">
    ...
    <div class="container text-center">
        ...
        <div class="row">
            ...
            <div class="col">
                <img src="${pageContext.request.contextPath}/CarsPhotos?id=${car.id}" width="48">
            </div>
            <div class="col">
                <c:if test="${pageContext.request.isUserInRole('WRITE_CARS')}">
<%--                    <div class="col">--%>
                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/AddCarPhoto?id=${car.id}">
                            Add photos</a>
<%--                    </div>--%>
<%--                    <div class="col">--%>
